...
export var BattlesSection: React.FC<Prop> = function ({ win, lost, color }) {
  return (
    <Container color={color}>
      ...
      <Wrapper>
        <ValueWrapper>
          ...
          <Text fontColors={Colors.Muted} css="margin: 0;">
            Win
          </Text>
        </ValueWrapper>
        <Seporate />
